...
void window::init()
{
    program.add_shader_from_source_file(tinygl::shader::type::vertex, "textures_exercise1.vert");
    program.add_shader_from_source_file(tinygl::shader::type::fragment, "textures_exercise1.frag");
    program.link();
