...
void Window::init()
{
    program.addShaderFromSourceFile(tinygl::Shader::Type::Vertex, "textures_exercise1.vert");
    program.addShaderFromSourceFile(tinygl::Shader::Type::Fragment, "textures_exercise1.frag");
    program.link();
