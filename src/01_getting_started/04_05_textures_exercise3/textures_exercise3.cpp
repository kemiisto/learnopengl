...
{
    texture0.bind();
    texture0.set_wrap_mode(tinygl::texture::wrap_mode::clamp_to_edge);
    texture0.set_min_mag_filters(tinygl::texture::nearest, tinygl::texture::nearest);
    texture0.unbind();

    texture1.bind();
    texture1.set_wrap_mode(tinygl::texture::wrap_mode::repeat);
    texture1.set_min_mag_filters(tinygl::texture::nearest, tinygl::texture::nearest);
    texture1.unbind();

    program.add_shader_from_source_file(tinygl::shader::type::vertex, "textures_exercise3.vert");
    program.add_shader_from_source_file(tinygl::shader::type::fragment, "textures_exercise3.frag");
    program.link();
