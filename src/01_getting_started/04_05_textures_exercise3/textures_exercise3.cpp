...
{
    texture0.bind();
    texture0.setWrapMode(tinygl::Texture::WrapMode::ClampToEdge);
    texture0.setMinMagFilters(tinygl::Texture::Nearest, tinygl::Texture::Nearest);
    texture0.unbind();

    texture1.bind();
    texture1.setWrapMode(tinygl::Texture::WrapMode::Repeat);
    texture1.setMinMagFilters(tinygl::Texture::Nearest, tinygl::Texture::Nearest);
    texture1.unbind();

    program.addShaderFromSourceFile(tinygl::Shader::Type::Vertex, "textures_exercise3.vert");
    program.addShaderFromSourceFile(tinygl::Shader::Type::Fragment, "textures_exercise3.frag");
    program.link();
