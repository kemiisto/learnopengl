...
void Window::init()
{
    program.addShaderFromSourceFile(tinygl::Shader::Type::Vertex, "transformations_exercise2.vert");
    program.addShaderFromSourceFile(tinygl::Shader::Type::Fragment, "transformations_exercise2.frag");
    program.link();
