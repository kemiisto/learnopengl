...
void window::init()
{
    program.add_shader_from_source_file(tinygl::shader::type::vertex, "transformations_exercise2.vert");
    program.add_shader_from_source_file(tinygl::shader::type::fragment, "transformations_exercise2.frag");
    program.link();
...
void window::draw() {
    ...
    tinyla::geom::post_translate(transformation, {-0.5f, 0.5f, 1.0f});
    auto scale = std::sin(tinygl::get_time<float>());
