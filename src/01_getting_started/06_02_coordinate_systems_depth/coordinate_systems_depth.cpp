...
void window::init()
{
    program.add_shader_from_source_file(tinygl::shader::type::vertex, "coordinate_systems_depth.vert");
    program.add_shader_from_source_file(tinygl::shader::type::fragment, "coordinate_systems_depth.frag");
    program.link();
...
void window::draw() {
    ...
    tinyla::geom::post_rotate(model, tinyla::geom::angle<float>::from_radians(tinygl::get_time<float>()), {0.5f, 1.0f, 0.0f});
