...
void window::init()
{
    program.add_shader_from_source_file(tinygl::shader::type::vertex, "textures_combined.vert");
    program.add_shader_from_source_file(tinygl::shader::type::fragment, "textures_combined.frag");
    program.link();
